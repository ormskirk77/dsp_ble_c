...
{		//DSP CONTROLLER SERVICE
		...
		//DSP CONTROLLER VOLUME CHARATERISTIC DECLARATION
...
static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
	...
	switch(event) {
		...
		case ESP_GAP_BLE_ADV_DATA_SET_COMPLETE_EVT:
			printf("gap_event_handler: ");
			printf("ESP_GAP_BLE_ADV_DATA_SET_COMPLETE_EVT called.\n");
			esp_ble_gap_start_advertising(&adv_params);
		break;
		case ESP_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT:
			printf("gap_event_handler: ");
			printf("ESP_GAP_BLE_SCAN_RSP_DATA_SET_COMPLETE_EVT called.\n");
			esp_ble_gap_start_advertising(&adv_params);
		break;
		...
		case ESP_GAP_BLE_ADV_STOP_COMPLETE_EVT:
			printf("gap_event_handler: ");
			printf("ESP_GAP_BLE_ADV_STOP_COMPLETE_EVT called.\n");
			break;
...
void gatts_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
	switch(event) {
		...
		case ESP_GATTS_CREAT_ATTR_TAB_EVT:
			printf("gatts_profile_event_handler: ");
			printf("ESP_GATTS_CREAT_ATTR_TAB_EVT called.\n");
